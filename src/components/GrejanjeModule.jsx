  ...
  return (
    <div className="space-y-4 sm:space-y-6">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 sm:gap-0">
        <h3 className="text-lg sm:text-xl font-semibold text-gray-800">Grejanje</h3>
        <button
          onClick={handleAdd}
        ...
        >
          ...
          <span className="hidden sm:inline">Dodaj grejanje</span>
      ...
      {grejanja.length === 0 ? (
        ...
        <div className="bg-white rounded-lg shadow overflow-hidden">
          ...
          <div className="md:hidden divide-y divide-gray-200">
            {filteredAndSortedData.map((grejanje) => (
              <div key={grejanje.id} className="p-4 hover:bg-gray-50">
                <div className="flex justify-between items-start mb-3">
                  <div className="flex-1">
                    <div className="text-xs text-gray-500 mb-1">ID: {grejanje.id}</div>
