  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h2 className="text-3xl font-bold text-gray-900 tracking-tight">Opštine</h2>
          <p className="text-gray-500 mt-1">Upravljanje opštinama</p>
        </div>
        <button
          onClick={handleAdd}
        ...
        >
          ...
          <span>Dodaj opštinu</span>
        </button>
      </div>

      {gradovi.length === 0 && (
        <div className="bg-amber-50 border border-amber-200 rounded-2xl p-4">
          <p className="text-amber-800 font-medium">Morate prvo dodati grad pre dodavanja opština.</p>
        </div>
      )}
      ...
      {opstine.length === 0 ? (
        <div className="bg-white rounded-3xl shadow-lg border border-gray-100 p-16 text-center">
          ...
          <p className="text-gray-900 text-xl font-semibold mb-2">Nema opština</p>
          <p className="text-gray-500 mb-6">Dodajte prvu opštinu</p>
          <button
            onClick={handleAdd}
        ...
        <div className="bg-white rounded-3xl shadow-lg border border-gray-100 overflow-hidden">
            ...
            <table className="min-w-full">
              ...
              <tbody className="divide-y divide-gray-100">
                {filteredAndSortedData.map((opstina) => {
                  ...
                  return (
                    <tr key={opstina.id} className="hover:bg-amber-50 border-l-4 border-l-transparent hover:border-l-amber-500 transition-all duration-200">
          ...
          <div className="md:hidden divide-y divide-gray-100">
            {filteredAndSortedData.map((opstina) => {
              const gradOpis = gradovi.find(g => g.id === opstina.idgrad)?.opis || 'N/A'
              return (
                <div key={opstina.id} className="p-4 hover:bg-amber-50 border-l-4 border-l-transparent hover:border-l-amber-500 transition-all duration-200">
